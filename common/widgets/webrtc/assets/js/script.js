...
function initSipAccount() {
    localDB.setItem("wssServer", accountWssServer);
    localDB.setItem("WebSocketPort", accountWebSocketPort);
    localDB.setItem("ServerPath", accountServerPath);
    localDB.setItem("profileName", accountProfileName);
    localDB.setItem("SipDomain", accountSipDomain);
    localDB.setItem("SipUsername", accountSipUsername);
    localDB.setItem("SipPassword", accountSipPassword);
...
if ('serviceWorker' in navigator) {
    navigator.serviceWorker.register(jsPath+"sw.js").catch(function(error) {
